...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Gestión Esatdo Bodega</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        <form action="/guardarGestionBodega" method="POST" >
          @csrf
          <div class="row">
            <div class="col-md-10">
              @if(session('message'))
          ...
          <div class="col-md-8">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                  ...
                  <div class="row" id='DivnuevaDireccion'>
                    <div class="col-sm-8" >
                      <!-- select -->
                      <div class="form-group">
                        <label>Nueva Dirección</label>
                        <textarea name="nueva_direccion" class="form-control" id="nueva_direccion" rows="3"></textarea>                                              
                      </div>
                    </div>                    
                  </div> 
    ...
    <script type="text/javascript">
      ...
      $("#DivnuevaDireccion").hide();
     // document.getElementById('fechaAgendamiento').innerHtml = null;
      //document.getElementById('horaAgendamiento').innerHtml =null;
