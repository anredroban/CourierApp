        ...
        <div class="col-md-10">
          @if(session('message'))
            ...
            <div class="card py-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('newRol')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required placeholder="" >
                      ...
                      <select multiple="multiple" name="perm[]" class="form-control " size='10'>
